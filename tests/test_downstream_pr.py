...
class TestDownstreamPR(unittest.TestCase):
    ...
    def test_update_jira_issue(self,
        ...
        # Call the function
        d.update_jira_issue('mock_existing', self.mock_pr, mock_client)

        # Assert everything was called correctly
        mock_client.add_comment.assert_called_with('mock_existing', 'mock_formatted_comment')
        mock_format_comment.assert_called_with(self.mock_pr, self.mock_pr.suffix)
        mock_comment_exists.assert_called_with(mock_client, 'mock_existing', 'mock_formatted_comment')
    ...
    def test_comment_exists_false(self):
        ...
        # Call the function
        response = d.comment_exists(mock_client, 'mock_existing', 'mock_new_comment')

        # Assert Everything was called correctly
        mock_client.comments.assert_called_with('mock_existing')
    ...
    def test_format_comment_open(self):
        ...
        """
        # Call the function
        response = d.format_comment(self.mock_pr, 'open')
